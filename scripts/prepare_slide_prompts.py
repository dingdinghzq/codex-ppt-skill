    ...
    *,
    ...
    if global_style_reference:
        prompt_parts.append(
            ...
            "Use Image 1 as the internally accepted style-anchor reference. Match its palette, "
    ...
    language = str(deck.get("language", "Chinese")).strip() or "Chinese"
    prompt_parts.append(
        "## Universal Constraints\n"
        "- The final image itself must contain the title and key points.\n"
        f"- Render all visible {language} text exactly and legibly; avoid garbled characters.\n"
...
def _write_template(path: Path) -> None:
    template = {
        ...
        "sample_generation_method": {
            ...
            "tool_name": "image_gen",
            "mode": "generate",
            "prompt_source": "the internally accepted style-anchor slide job prompt",
            "size": "16:9 landscape, 2560x1440 target",
            "quality": "medium",
            "approved_sample_path": "/absolute/path/to/accepted-style-anchor-slide.png",
        ...
        "approved_style_reference": {
            "path": "/absolute/path/to/accepted-style-anchor-slide.png",
            "role": "accepted style-anchor slide reference",
